...
class TrainingConfig:
    ...
    reconstruction_distribution: str = "mse"
    nb_input_transform: str = "log1p"
    nb_theta: float = 2.5815883941220323
...
class WeightingConfig:
    weight_fusion_mode: str = "additive"
    cluster_weight_power: float = 1.0
    density_weight_power: float = 1.0
